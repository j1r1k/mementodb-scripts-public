...
function getDuration(e) {
  ...
  if (startDate || endDate) {
    ...
    const end = combineDateAndTime(endDate || startDate, endTime || startTime);
...
function getStart(e) {
  ...
  if (endDate || endTime) {
    const date = combineDateAndTime(endDate || startDate, endTime || startTime);
...
function getEnd(e) {
  ...
  if (startDate || startTime) {
    const date = combineDateAndTime(startDate || endDate, startTime || endTime);
